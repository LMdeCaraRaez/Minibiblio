 ...
 */
final class Version20250122085042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE socio (id INT AUTO_INCREMENT NOT NULL, dni VARCHAR(255) NOT NULL, apellidos VARCHAR(255) DEFAULT NULL, nombre VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_38B653097F8F253B (dni), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
